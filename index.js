...
function imgChange(){
    if (imgNumber==0) {
          document.getElementById("result").innerHTML="<img class='anh'  src='tải xuống.jpg'  alt=''>"
          imgNumber=1
          console.log(imgNumber);
          
    }else{
          document.getElementById("result").innerHTML="<img class='anh'  src='tải xuống (1).jpg'  alt=''>"
          imgNumber=0
          console.log(imgNumber);
    }
